...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if (buttonIndex == alertView.firstOtherButtonIndex) {
        ...
        NSDictionary *orderCoffe=_result[(int)orderNum];
        
        NSString *coffeName =[NSString stringWithFormat:@"%@ :%@",orderCoffe[@"name"],@"hot"];
        
        NSDictionary *requestDic =
        @{@"coffee":coffeName, @"orderer" : @"이현우"};
        NSLog(@"%@",coffeName);
